package com.ymc.lib_ijk.ijk.utils;
...
import com.ymc.lib_ijk.ijk.listener.IJKVideoProgressListener;
import com.ymc.lib_ijk.ijk.listener.LockClickListener;
import com.ymc.lib_ijk.ijk.listener.VideoAllCallBack;
...
import static com.ymc.lib_ijk.ijk.utils.CommonUtil.getActionBarHeight;
import static com.ymc.lib_ijk.ijk.utils.CommonUtil.getStatusBarHeight;
import static com.ymc.lib_ijk.ijk.utils.CommonUtil.hideNavKey;
import static com.ymc.lib_ijk.ijk.utils.CommonUtil.showNavKey;
...
public class IJKVideoHelper {
    ...
    public IJKVideoHelper(Context context) {
        this(context, new StandardIJKVideoPlayer(context));
    }

    public IJKVideoHelper(Context context, StandardIJKVideoPlayer player) {
