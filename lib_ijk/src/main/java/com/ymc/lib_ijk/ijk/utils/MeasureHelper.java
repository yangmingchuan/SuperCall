...
public final class MeasureHelper {
    ...
    private int mCurrentAspectRatio = IJKVideoType.SCREEN_TYPE_DEFAULT;
    ...
    public void doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mCurrentAspectRatio = IJKVideoType.getShowType();
        ...
        if (mCurrentAspectRatio == IJKVideoType.SCREEN_MATCH_FULL) {
            ...
            if (widthSpecMode == View.MeasureSpec.AT_MOST && heightSpecMode == View.MeasureSpec.AT_MOST) {
                ...
                switch (mCurrentAspectRatio) {
                    case IJKVideoType.SCREEN_TYPE_16_9:
                        displayAspectRatio = 16.0f / 9.0f;
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case IJKVideoType.SCREEN_TYPE_18_9:
                        displayAspectRatio = 18.0f / 9.0f;
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case IJKVideoType.SCREEN_TYPE_4_3:
                        displayAspectRatio = 4.0f / 3.0f;
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case IJKVideoType.SCREEN_TYPE_CUSTOM:
                        displayAspectRatio = IJKVideoType.getScreenScaleRatio();
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case IJKVideoType.SCREEN_TYPE_DEFAULT:
                    case IJKVideoType.SCREEN_TYPE_FULL:
